...
function setupScene(gltf) {
	...
	if (container.clientWidth >= 800) avatar.scale.set(1.5, 1.0, 1.5);
	else avatar.scale.set(1.0, 1.0, 1.0);
	scene.add(avatar);
	...
	const waveClip = THREE.AnimationClip.findByName(clips, 'waving_avatar');
	const stumbleClip = THREE.AnimationClip.findByName(clips, 'stagger_avatar');
